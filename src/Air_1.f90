...
real(dbl) :: nk0(13), nk(19), ik(19), jk(19), lk(19)
...
real(dbl) :: dry_f_si
real(dbl) :: t_si, d_si
real(dbl) :: tr, dr, ra, f, tau, del, a, a_t, a_tt, a_d, a_td, a_dd
...
real(dbl) :: air_baw_m3mol
integer :: drv_t
real(dbl) :: t_si
real(dbl) :: c1, c2, c3, tr, d1, d2, d3
real(dbl) :: t, b
...
real(dbl) :: air_caaw_m6mol2
integer :: drv_t
real(dbl) :: t_si
real(dbl) :: c1, c2, c3, c4, c5, tr
real(dbl) :: t, c
...
real(dbl) air_caww_m6mol2
integer :: drv_t
real(dbl) :: t_si
real(dbl) c1, c2, c3, c4, tr
real(dbl) t, c
...
real(dbl) alpha_res
real(dbl) :: tau, del, a, a_tau, a_del, i, j, l
