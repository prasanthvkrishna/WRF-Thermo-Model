...
real(dbl) air_g_chempot_vap_si, a_si, t_si, p_si
real(dbl) g, g_a
...
!=========================================================================
function air_g_chempot_dair_si(a_si, t_si, p_si)
!=========================================================================
...
real(dbl) air_g_chempot_dair_si, a_si, t_si, p_si
real(dbl) g, g_a

air_g_chempot_dair_si = errorreturn
...
air_g_chempot_dair_si = g + (1-a_si) * g_a  !g - A(dg/dA)
...
real(dbl) air_g_compressibilityfactor_si, a_si, t_si, p_si
real(dbl) d, rav
...
real(dbl) air_g_contraction_si, a_si, t_si,p_si
real(dbl) d, g_ap
...
real(dbl) air_g_cp_si, a_si, t_si, p_si
real(dbl) d
...
real(dbl) air_g_cv_si, a_si, t_si, p_si
real(dbl) d
...
real(dbl) air_g_density_si, a_si, t_si, p_si
...
real(dbl) air_g_enthalpy_si, a_si, t_si, p_si
real(dbl) d
...
real(dbl) air_g_entropy_si, a_si, t_si, p_si
real(dbl) d
...
real(dbl) air_g_expansion_si, a_si, t_si, p_si
real(dbl) d
...
real(dbl) air_g_gibbs_energy_si, a_si, t_si, p_si
real(dbl) d
...
real(dbl) air_g_internal_energy_si, a_si, t_si, p_si
real(dbl) d
...
real(dbl) air_g_kappa_s_si, a_si, t_si, p_si
real(dbl) d
...
real(dbl) air_g_kappa_t_si, a_si, t_si, p_si
real(dbl) d
...
real(dbl) air_g_lapserate_si, a_si, t_si, p_si
real(dbl) d
...
real(dbl) air_g_soundspeed_si, a_si, t_si, p_si
real(dbl) d
...
real(dbl) ma, d, t, x, p
real(dbl) temp, dens, pres, inte, enth, entr, cv, cp, cs
real(dbl) holdit
integer mode, i, j
character*130 row
character*90 fmt
